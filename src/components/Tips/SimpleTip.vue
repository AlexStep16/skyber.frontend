    ...
    return {
      tipsTranslator: {
        1: {
          ...
          description: 'Добро пожаловать! Для описания теста можно воспользоваться встроенным редактором (просто выделите текст)',
        },
        2: {
          header: 'Добавление вопросов',
          description: 'Чтобы добавить вопрос нажмите на кнопку плюса',
        },
        3: {
        ...
        4: {
          ...
          description: 'Для добавления видео вам нужна ссылка с YouTube',
        },
        5: {
