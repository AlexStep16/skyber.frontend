      ...
      <div class="options">
        <div>
          <input
            ...
            name="name"
            id="name"
            class="input input_type-option input_theme-dark"
            placeholder="Название теста или опроса"
            v-model="form.name"
          />
        </div>
        <div class="mt5">
          <div class="option" @click="makeTest">ТЕСТ</div>
          <div class="option" @click="makePoll">ОПРОС</div>
        </div>
      </div>
    </div>
  </div>
